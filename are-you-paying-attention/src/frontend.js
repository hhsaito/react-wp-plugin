...
function Quiz(props) {
    ...
    useEffect( () => {
        // timeout to change isCorrect back to undefined for incorrect answer
        if ( isCorrect === false ) {
            setTimeout( () => {
                ...
                {props.answers.map( function (answer, index) {
                    return (
                        ...
                        {isCorrectDelayed === true && index === props.correctAnswer  && (
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" className="bi bi-patch-check-fill" viewBox="0 0 16 16">
